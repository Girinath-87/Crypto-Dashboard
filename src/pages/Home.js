...
const Home = () => {
  ...
  return (
    <div className="home">
      <h1 className="dashboard-title">Cryptoverse Dashboard</h1>
      ...
      {globalStats && (
        <div className="global-stats">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-item">
              <strong>Total 24h Volume:</strong> ${globalStats.total_volume.usd.toLocaleString()}
            </div>
            <div className="stat-item">
      ...
      <h2 className="crypto-heading">Top 10 Cryptocurrencies</h2>
